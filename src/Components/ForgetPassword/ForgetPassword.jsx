            ...
            <div className="forgetPwd-mainDiv-cnt">
                <div className="forgetPwd-subMainDiv-cnt">
                    ...
                    <div className="forgetPwd-div1-cnt">
                        <input type="text" placeholder="EmailId" value={emailId} className="forgetPwd-input1-cnt w-fit " maxLength="256" onChange={(e) => setEmailId(e.target.value)}/>
                        <span className="forgetPwd-span2-cnt">{errorMessage}</span>
                        <button className="forgetPwd-button1-cnt" onClick={()=>handleSubmit()}>Submit</button>
