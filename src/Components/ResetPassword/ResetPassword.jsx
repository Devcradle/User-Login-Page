...
import { resetPasswordAdmin } from '../../utils/Api';
...
const ResetPassword = () => {
  ...
  const handleReset = async (e) => {
    try {
      e.preventDefault();
      setMessage('');
      const data = await resetPasswordAdmin(`resetPassword/${id}`, {
        password
      });
      setPassword('');
      ...
      <div className="resetPwd-maindiv-cnt">
        <form>
          <div className="resetPwd-subdiv-cnt">
            ...
            <button
              className="resetPwd-button1-cnt"
